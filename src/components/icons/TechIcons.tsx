...
export const GitHubIcon = createIcon(FaGithub, "#181717");
...
export const NextjsIcon = createIcon(SiNextdotjs, "#000000");
...
export const VercelBlobIcon = createIcon(FaCloud, "#000000");
export const VercelIcon = createIcon(SiVercel, "#000000");
